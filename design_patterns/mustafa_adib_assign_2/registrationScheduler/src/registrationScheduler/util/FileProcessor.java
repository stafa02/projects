...
public class FileProcessor {
	...
	/**
	 * 
	 * @param bufReaderIn reader instance for file
	 */
	...
	/**
	 * 
	 * @param outFileNameIn output file name
	 * @throws IOException
	 */
	...
	/**
	 * 
	 * @param line to be written to file
	 * @throws IOException
	 */
	public synchronized void writeLineToFile(String line) throws IOException {
		out.write(line);
	}
