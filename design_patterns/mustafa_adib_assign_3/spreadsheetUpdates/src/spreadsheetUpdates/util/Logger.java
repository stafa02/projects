...
public class Logger {
	...
	public static enum DebugLevel {
		RELEASE, PRINT_RESULTS, IN_NOTIFY, IN_REGISTER, CONSTRUCTOR
	};
	...
	public static void setDebugValue(int levelIn) {
		...
		case 4:
			...
			break;
		case 3:
			debugLevel = DebugLevel.IN_REGISTER;
			break;
		case 2:
			debugLevel = DebugLevel.IN_NOTIFY;
			break;
		case 1:
			debugLevel = DebugLevel.PRINT_RESULTS;
			break;
		case 0:
